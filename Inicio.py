...
class TabletApp(MDApp):
    ...
    def mostrar_a_pantalla_completa(self, celda_real):
        ...
        self.boton_historial = MDRectangleFlatIconButton(
            ...
            size_hint=(None, None),
            size=(dp(180), dp(50)),
            pos_hint={'right': 0.165, 'center_y': 0.86},  # izquierda centrado vertical
        ...
        self.boton_finalizar = MDRectangleFlatIconButton(
            text="Finalizar",
            icon="clipboard-check",  # Icono Material Design
            theme_text_color="Custom",
            text_color=(1, 1, 1, 1),
            icon_color=(1, 1, 1, 1),
            line_color=(0, 0.7, 0, 1),  # verde borde
            md_bg_color=(0, 0.7, 0, 1), # verde relleno
            size_hint=(None, None),
            padding= (dp(18), dp(60)),
            size=(dp(220), dp(70)),
            font_size=dp(18),
            pos_hint={'right': 0.98, 'top': 0.35},
